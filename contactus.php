...
<html>
  ...
  <head>
    <title> Contact | Ernest Cafe' </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Food Arena </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Ernest Cafe' </span>?</strong>
     <br>
