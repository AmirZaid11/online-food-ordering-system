    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        <div class="container">
          <div class="jumbotron">
            <h1>Select your payment option Kindly</h1>
          </div>
        </div>
        <br>
<h1 class="text-center">Grand Total: Ksh.<?php echo "$gtotal"; ?>/-</h1>
<h5 class="text-center">Including all other service charges. (No delivery charges)</h5>
<br>
<h1 class="text-center">
  ...
  <a href="COD.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Pay On Delivery</button></a>
</h1>
